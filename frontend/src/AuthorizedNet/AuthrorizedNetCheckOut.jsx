...
// 	merchantAuthenticationType.setName('3ap2HK6cb');
// 	merchantAuthenticationType.setTransactionKey('36L49QfFTxy6S8tv');
...
function AuthrorizedNetCheckOut() {
    useEffect(()=>{
        // chargeCreditCard(()=>{console.log('chargeCreditCard call complete')});
    })
  return (
    <div>AuthrorizedNetCheckOut</div>
  )
}

export default AuthrorizedNetCheckOut